...
std::vector<tree<HTML::Node>> MyExtension::GetSpecialNodeByTagProp(tree<HTML::Node> dom, std::vector<MyExtension::NodePropBase> ConditionLIB)
{
...
void MyExtension::PrintSpecialNodeByTagProp(tree<HTML::Node> dom, std::vector<MyExtension::NodePropBase> ConditionLIB)
{
	//存放过滤条件
	//vector<FilterCondition> ConditionLIB = { { "lkj", "asa4534safdfafga" }, { "ta", "aghse" } };
	tree<HTML::Node>::iterator it = dom.begin();
